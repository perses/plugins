...
function SpanLinkItem(props: SpanLinkItemProps): ReactElement {
  ...
  return (
    <List>
      <AttributeItem name="trace ID" value={link.traceId} link={spanLink} customLinks={customLinks} />
      <AttributeItem name="span ID" value={link.spanId} link={spanLink} customLinks={customLinks} />
