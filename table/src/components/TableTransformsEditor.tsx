...
export type TableTransformsEditorProps = OptionsEditorProps<TableOptions>;

export function TableTransformsEditor({ value, onChange }: TableTransformsEditorProps): ReactElement {
