...
import { createBucketToolTip, escapeHtml, ToolTipChartData } from './traceheatmap-tooltip-util';
...
describe('traceheatmap-tooltip-util', () => {
  describe('escapeHtml', () => {
    [
      ...
      it(`should replace ${i.ch} with ${i.substitute}`, () => {
        expect(escapeHtml(i.ch)).toBe(i.substitute);
      });
    });
  });
  describe('tool-tip', () => {
