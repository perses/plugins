...
describe('LogsTablePanel', () => {
  ...
  it('should render multi values with timestamps', async () => {
    ...
    expect(await screen.findAllByText('1666625490000')).toHaveLength(1); // first timestamp appear once per line
    expect(await screen.findAllByText('1666625490001')).toHaveLength(1); // second timestamp appear once per line
  });
});
