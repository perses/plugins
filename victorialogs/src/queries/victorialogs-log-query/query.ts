...
import { LogEntry, LogsData } from '../../panels/logstable/types';
import { DEFAULT_DATASOURCE } from '../constants';
import { VictoriaLogsLogQuerySpec } from './types';
import { LogQueryPlugin, LogQueryContext } from './interface';

function convertStreamToLogs(data: VictoriaLogsStreamQueryRangeResponse, defaultTime: string): LogsData {
