...
TODO put somewhere: As a pre-requisite, if the plugin's schema relies on the `github.com/perses/perses/cue`, you have to authenticate to CUE's Central registry to be allowed to retrieve dependencies: `cue login`