...
export const JAEGER_DATASOURCE_KIND = 'JaegerDatasource' as const;

export interface JaegerDatasourceSelector extends DatasourceSelector {
  kind: typeof JAEGER_DATASOURCE_KIND;
}

export const DEFAULT_JAEGER: JaegerDatasourceSelector = { kind: JAEGER_DATASOURCE_KIND };

export function isDefaultJaegerSelector(datasourceSelectValue: DatasourceSelectValue): boolean {
