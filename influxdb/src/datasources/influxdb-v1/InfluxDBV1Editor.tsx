...
import { InfluxDBV1Spec } from '../../model';
export function InfluxDBV1Editor({ value, onChange }: OptionsEditorProps<InfluxDBV1Spec>) {
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <TextField
        ...
        helperText="The InfluxDB database to query"
        required
        fullWidth
      />
    </Box>
