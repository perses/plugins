...
import { resolveAutoColumns } from './stat-chart-model';
...
export const StatChartPanel: FC<StatChartPanelProps> = (props) => {
  ...
  const autoColumnCount = useMemo(() => {
    ...
    const widthBased = Math.floor((panelWidth + SPACING) / (MIN_WIDTH + SPACING));
    return resolveAutoColumns(statChartData.length, widthBased, spec.seriesColumns);
